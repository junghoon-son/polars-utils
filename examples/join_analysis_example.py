...
def main():
    ...
    shapes_table.add_row("Customers", f"{customers.shape[0]} rows × {customers.shape[1]} columns")
    shapes_table.add_row("Orders", f"{orders.shape[0]} rows × {orders.shape[1]} columns")
    shapes_table.add_row("Regions", f"{regions.shape[0]} rows × {regions.shape[1]} columns")
    ...
    console.print("[yellow]Expected:[/] [bold green]customer_id[/] should be the optimal join key")
    ...
    console.print("[yellow]Expected:[/] [bold green]region_id[/] should be the optimal join key")
    ...
    for match in results_orders[:3]:
        ...
        console.print(f"  • Customers matching orders: [green]{match.left_match_percentage:.1f}%[/]")
        console.print(f"  • Orders matching customers: [green]{match.right_match_percentage:.1f}%[/]")
